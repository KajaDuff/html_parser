...
def scrape_partial_report(input_dir, output_dir, fname):
    ...
    with open(os.path.join(input_dir, fname), "r", encoding = 'utf-8') as protokol:
        ...
        t = html.find("table", class_="ripTable naklady")
        data = t.tbody
        ...
        for row in data.find_all("tr"):
            ...
            for i, td in enumerate(tds):
                if i == 0:
                    ...
                    v = td.div.find_previous('input')['value']
                else:
                    continue
            r[k] = v
        ...
        for member in member_field:
            ...
            headers = member_table.tbody.find_all("th")
            data = member_table.tbody.find_all("td")
        ...
        for partime_member in partime_member_field:
            ...
            headers2 = partime_member_table.tbody.find_all("th")
            data2 = partime_member_table.tbody.find_all("td")
...
json_output_dir = os.path.join(dir_path, 'output_json')
fname = 'ISVP - Dílčí zpráva k projektu NV18-03-00024 za rok 2020.html'


if __name__ == '__main__':
    scrape_partial_report(files_dir, json_output_dir, fname)
